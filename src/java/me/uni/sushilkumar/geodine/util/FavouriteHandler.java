 ...
 */
public class FavouriteHandler extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
           ...
           String cuisineId=con.getCuisineId(id);
           out.println("<h1>"+cuisineId+"</h1>");
           if(email!=null)
           {
           if(!con.isFavourite(cuisineId,email))
           {
               con.addFavourite(cuisineId, email);
           }
           }
           else
           {
